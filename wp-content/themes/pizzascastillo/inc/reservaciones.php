...
function pizzascastillo_eliminar() {
  if(isset($_POST[tipo])) {
...
add_action('wp_ajax_pizzascastillo_eliminar', 'pizzascastillo_eliminar');


function pizzascastillo_guardar() {
  ...
  if(isset($_POST['enviar']) && $_POST['oculto'] == "1"):
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
      ...
      $campos = array(
        'secret' => '6Lf3sq0UAAAAALjUtNgIkNzplm3tSysgkM9d2lH0',
        'response' => $captcha,
      ...
      //Tener una cadena codificada para la URL
...
add_action('init', 'pizzascastillo_guardar');
